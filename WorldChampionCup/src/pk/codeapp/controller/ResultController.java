...
public class ResultController implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == resultScreen.getBtnCreate()) {
            ...
            jumpToWinAux("Create");
                ...
                JOptionPane.showMessageDialog(resultScreen," Please fill the calendar to Create a Result");
        }
    ...
    public void fillAllInformation() {
        if (resultScreen.getActualResult().getTeamWinnew().equals(resultScreen.getActualResult().getTeamLoser())) {
            ...
            resultScreen.getLblTie().setText("TIE");
        } else {
            resultScreen.getLblNameTeamWinner().setText("Team Winner");
            resultScreen.getLblNameTeamLoser().setText("Team Lost");
