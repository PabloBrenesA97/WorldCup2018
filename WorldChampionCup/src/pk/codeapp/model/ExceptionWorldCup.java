...
public class ExceptionWorldCup extends Exception{
    ...
    private final String[] LIST_EXCEPTION = {"1) You can not eliminate stadiums that have matches",
        ...
        "10) There is not element","11) No more elements can be added","12) Must be older than 19","13) You can not choose the same Teams","14) Negative numbers are not allowed"};
